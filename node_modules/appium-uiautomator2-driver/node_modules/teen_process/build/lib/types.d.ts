 ...
 */
export type BufferProp<T extends {
    isBuffer?: boolean;
}> = T['isBuffer'] extends true ? Buffer : string;
/**
 ...
 */
export type StartDetector<T extends SubProcessOptions> = (stdout: T extends TIsBufferOpts ? Buffer : string, stderr?: T extends TIsBufferOpts ? Buffer : string) => unknown;
